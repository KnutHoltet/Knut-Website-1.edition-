    ...
    return RichText(
      text: TextSpan(
        ...
        children: <TextSpan> [
          ...
          TextSpan(
            text: "\n\nNote* - nettsiden er skrevet ved hjelp av Flutter, (ish en ukes erfaring, as of 4. september). Men ville lære meg noe nytt, og egne nettsider er obligatorisk nå om dagen (jobbsøkningstid for karrieredager osv!)! Altså kan du se på nettsiden som en glorifisert CV / visittkort.",
            style: GoogleFonts.jetBrainsMono(
                textStyle: TextStyle(color: flavor.text)
            ),
